    ...
    return (
        <section className='conteiner-point conteiner-point_theme_dark conteiner-padding'>
            ...
            <div className='plan ' id ="project">
                ...
                <p className='plan__text-secondary'>Составление плана, работу над бэкендом, вёрстку, добавление функциональности и финальные доработки.</p>
                <p className='plan__text-secondary'>У каждого этапа был мягкий и жёсткий дедлайн, которые нужно было соблюдать, чтобы успешно защититься.</p>
            </div>
